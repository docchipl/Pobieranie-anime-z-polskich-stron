...
function ServiceMioroSubs(anime, episode) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.get(`https://miorosubs.pl/episodes/${anime}x${episode}`, {
                headers: {
...
exports.default = ServiceMioroSubs;
