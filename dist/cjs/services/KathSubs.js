...
function ServiceKathSubs(anime, episode) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.get(`https://kathsubs.blogspot.com/p/${anime}.html`, {
                headers: {
            ...
            yield Promise.all(Array.from(items).map(function (x) {
                ...
                if (!link || !episodeNumber)
                    return;
                const data = (0, CompileEpisodeData_1.default)(link.href);
...
exports.default = ServiceKathSubs;
