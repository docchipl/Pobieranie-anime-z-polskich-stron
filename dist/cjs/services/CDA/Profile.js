...
function ServiceCDAProfile(user, keyword, type, spaces, episode) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield axios_1.default.get(`https://www.cda.pl/${user}`, {
                headers: {
            ...
            yield Promise.all(Array.from(items).map(function (x, index) {
                ...
                if (!pT || !pT.textContent || !pT.href)
                    return;
                if (!pT.textContent.includes(keyword))
                    return;
...
exports.default = ServiceCDAProfile;
